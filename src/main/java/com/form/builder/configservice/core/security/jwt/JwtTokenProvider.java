package com.form.builder.configservice.core.security.jwt;
...
public class JwtTokenProvider {
	...
	public String generateToken(final Authentication authentication) {
		...
		return Jwts.builder().setClaims(claims).setIssuedAt(new Date()).setExpiration(expiryDate).signWith(SignatureAlgorithm.HS512, jwtSecret).compact();
	}
